...
task_agent = Agent(
    name="TaskAgent",
    handoff_description="Handles all task and TODO management: creating, listing, completing, and checking overdue tasks across projects.",
    instructions="""
...
""",
    tools=[create_task, list_tasks, complete_task, list_overdue_tasks],
)
